 ...
 *
 * This class extends TextSearchOptionsAPI with OCR text search specific settings.
 */
class OcrTextOptionsAPI : public TextSearchOptionsAPI
{
public:
    /**
     * @brief Constructor
 ...
 *
 * This class extends TextSearchResultAPI for OCR text search results.
 */
class OcrTextResultAPI : public TextSearchResultAPI
{
public:
    /**
     * @brief Constructor
     ...
     */
    explicit OcrTextResultAPI(SearchResult &result);
