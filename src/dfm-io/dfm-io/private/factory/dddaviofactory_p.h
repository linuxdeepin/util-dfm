...
#ifndef DDDAVIOFACTORY_P_H
#define DDDAVIOFACTORY_P_H
...
class DDdavIOFactory;

class DDdavIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DDdavIOFactoryPrivate(DDdavIOFactory *q);
    ~DDdavIOFactoryPrivate() override;
