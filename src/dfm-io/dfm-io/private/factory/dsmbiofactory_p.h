...
#ifndef DSMBIOFACTORY_P_H
#define DSMBIOFACTORY_P_H
...
class DSmbIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DSmbIOFactoryPrivate(DSmbIOFactory *q);
    ~DSmbIOFactoryPrivate() override;
