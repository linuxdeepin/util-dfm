...
#ifndef DARCHIVEIOFACTORY_P_H
#define DARCHIVEIOFACTORY_P_H
...
class DArchiveIOFactory;

class DArchiveIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DArchiveIOFactoryPrivate(DArchiveIOFactory *q);
    ~DArchiveIOFactoryPrivate() override;
