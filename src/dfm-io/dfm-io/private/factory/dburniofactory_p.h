...
#ifndef DBURNIOFACTORY_P_H
#define DBURNIOFACTORY_P_H
...
class DBurnIOFactory;

class DBurnIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DBurnIOFactoryPrivate(DBurnIOFactory *q);
    ~DBurnIOFactoryPrivate() override;
