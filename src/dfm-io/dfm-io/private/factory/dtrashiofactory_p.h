...
#ifndef DTRASHIOFACTORY_P_H
#define DTRASHIOFACTORY_P_H
...
class DTrashIOFactory;

class DTrashIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DTrashIOFactoryPrivate(DTrashIOFactory *q);
    ~DTrashIOFactoryPrivate() override;
