...
#ifndef DAFPIOFACTORY_P_H
#define DAFPIOFACTORY_P_H
...
class DAfpIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DAfpIOFactoryPrivate(DAfpIOFactory *q);
    ~DAfpIOFactoryPrivate() override;
