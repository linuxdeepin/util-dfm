...
#ifndef DHTTPIOFACTORY_P_H
#define DHTTPIOFACTORY_P_H
...
class DHttpIOFactoryPrivate : public DIOFactoryPrivate
{
public:
    explicit DHttpIOFactoryPrivate(DHttpIOFactory *q);
    ~DHttpIOFactoryPrivate() override;
