...
#ifndef DNETWORKIOFACTORY_H
#define DNETWORKIOFACTORY_H
...
class DNetworkIOFactory : public DIOFactory
{
public:
    explicit DNetworkIOFactory(const QUrl &uri);
    ~DNetworkIOFactory();
...
private:
    QSharedPointer<DNetworkIOFactoryPrivate> d_ptr;
    Q_DECLARE_PRIVATE(DNetworkIOFactory)
};

END_IO_NAMESPACE

#endif // DNETWORKIOFACTORY_H
