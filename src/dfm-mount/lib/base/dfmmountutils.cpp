...
DeviceError Utils::castFromGError(const GError *const err)
{
    ...
    if (strcmp(errDomain, UDISKS_ERR_DOMAIN) == 0) {
        ...
        return DeviceError::UnhandledError;
    }
}
...
QString Utils::errorMessage(DeviceError err)
{
    static const QMap<DeviceError, QString> errors {
        ...
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorFailed, "Failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorCancelled, "Cancelled"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorAlreadyCancelled, "Already cancelled"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorNotAuthorized, "Not authorized"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorNotAuthorizedCanObtain, "Not authorized can obtain"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorNotAuthorizedDismissed, "Not authorized dismissed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorAlreadyMounted, "Device is already mounted"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorNotMounted, "Device is not mounted"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorOptionNotPermitted, "Option is not permitted"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorMountedByOtherUser, "Device is mounted by other user"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorAlreadyUnmounting, "Device is already unmounted"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorNotSupproted, "Not supported operation"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorTimedOut, "Operation time out"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorWouldWakeup, "Operation would wakeup"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorDeviceBusy, "Device is busy"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiDaemonTransportFailed, "SCSI daemon transport failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiHostNotFound, "SCSI host not found"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiIDMB, "SCSI IDMB"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiLoginFailed, "SCSI login failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiLoginAuthFailed, "SCSI login auth failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiLoginFatal, "SCSI login fatal"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiLogoutFailed, "SCSI logout failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiNoFirmware, "SCSI no firmware found"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiNoObjectsFound, "SCSI no objects found"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiNotConnected, "SCSI not connected"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiTransportFailed, "SCSI transport failed"),
        std::pair<DeviceError, QString>(DeviceError::UDisksErrorScsiUnknownDiscoveryType, "SCSI unknown discovery type"),

        std::pair<DeviceError, QString>(DeviceError::GIOErrorFailed, "GIOErrorFailed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotFound, "GIOErrorNotFound"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorExists, "GIOErrorExists"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorIsDirectory, "GIOErrorIsDirectory"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotDirertory, "GIOErrorNotDirertory"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotEmpty, "GIOErrorNotEmpty"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotRegularFile, "GIOErrorNotRegularFile"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotSymbolicLink, "GIOErrorNotSymbolicLink"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotMountableFile, "GIOErrorNotMountableFile"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorFilenameTooLong, "GIOErrorFilenameTooLong"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorInvalidFilename, "GIOErrorInvalidFilename"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorTooManyLinks, "GIOErrorTooManyLinks"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNoSpace, "GIOErrorNoSpace"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorInvalidArgument, "GIOErrorInvalidArgument"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorPermissionDenied, "GIOErrorPermissionDenied"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotSupported, "GIOErrorNotSupported"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotMounted, "GIOErrorNotMounted"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorAlreadyMounted, "GIOErrorAlreadyMounted"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorClosed, "GIOErrorClosed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorCancelled, "GIOErrorCancelled"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorPending, "GIOErrorPending"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorReadONly, "GIOErrorReadONly"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorCantCreateBackup, "GIOErrorCantCreateBackup"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorWrongETAG, "GIOErrorWrongETAG"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorTimedOut, "GIOErrorTimedOut"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorWouldRecurse, "GIOErrorWouldRecurse"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorBusy, "GIOErrorBusy"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorWouldBlock, "GIOErrorWouldBlock"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorHostNotFound, "GIOErrorHostNotFound"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorWouldMerge, "GIOErrorWouldMerge"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorFailedHandled, "GIOErrorFailedHandled"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorTooManyOpenFiles, "GIOErrorTooManyOpenFiles"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotInitilized, "GIOErrorNotInitilized"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorAddressInUse, "GIOErrorAddressInUse"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorPartialInput, "GIOErrorPartialInput"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorInvalidData, "GIOErrorInvalidData"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorDBusError, "GIOErrorDBusError"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorHostUnreachable, "GIOErrorHostUnreachable"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNetworkUnreachable, "GIOErrorNetworkUnreachable"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorConnectionRefused, "GIOErrorConnectionRefused"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorProxyFailed, "GIOErrorProxyFailed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorProxyAuthFailed, "GIOErrorProxyAuthFailed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorProxyNeedAuth, "GIOErrorProxyNeedAuth"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorProxyNotAllowed, "GIOErrorProxyNotAllowed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorBrokenPipe, "GIOErrorBrokenPipe"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorConnectionClosed, "GIOErrorConnectionClosed"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorNotConnected, "GIOErrorNotConnected"),
        std::pair<DeviceError, QString>(DeviceError::GIOErrorMessageTooLarge, "GIOErrorMessageTooLarge"),

        std::pair<DeviceError, QString>(DeviceError::GDBusErrorFailed, "GDBusErrorFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNoMemory, "GDBusErrorNoMemory"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorServiceUnknown, "GDBusErrorServiceUnknown"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNameHasNoOwner, "GDBusErrorNameHasNoOwner"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNoReply, "GDBusErrorNoReply"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorIOError, "GDBusErrorIOError"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorBadAddress, "GDBusErrorBadAddress"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNotSupported, "GDBusErrorNotSupported"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorLimitsExceeded, "GDBusErrorLimitsExceeded"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorAccessDenied, "GDBusErrorAccessDenied"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorAuthFailed, "GDBusErrorAuthFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNoServer, "GDBusErrorNoServer"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorTimeout, "GDBusErrorTimeout"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorNoNetwork, "GDBusErrorNoNetwork"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorAddressInUse, "GDBusErrorAddressInUse"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorDisconnected, "GDBusErrorDisconnected"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorInvalidArgs, "GDBusErrorInvalidArgs"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorFileNotFound, "GDBusErrorFileNotFound"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorFileExists, "GDBusErrorFileExists"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorUnknownMethod, "GDBusErrorUnknownMethod"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorTimedOut, "GDBusErrorTimedOut"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorMatchRuleNotFound, "GDBusErrorMatchRuleNotFound"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorMatchRuleInvalid, "GDBusErrorMatchRuleInvalid"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnExecFailed, "GDBusErrorSpawnExecFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnForkFailed, "GDBusErrorSpawnForkFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnChildExited, "GDBusErrorSpawnChildExited"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnChildSignaled, "GDBusErrorSpawnChildSignaled"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnFailed, "GDBusErrorSpawnFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnSetupFailed, "GDBusErrorSpawnSetupFailed"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnConfigInvalid, "GDBusErrorSpawnConfigInvalid"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnServiceInvalid, "GDBusErrorSpawnServiceInvalid"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnServiceNotFound, "GDBusErrorSpawnServiceNotFound"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnPermissionsInvalid, "GDBusErrorSpawnPermissionsInvalid"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnFileInvalid, "GDBusErrorSpawnFileInvalid"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSpawnNoMemory, "GDBusErrorSpawnNoMemory"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorUnixProcessIdUnkown, "GDBusErrorUnixProcessIdUnkown"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorInvalidSignature, "GDBusErrorInvalidSignature"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorInvalidFileContent, "GDBusErrorInvalidFileContent"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorSeLinuxSecurityContextUnknown, "GDBusErrorSeLinuxSecurityContextUnknown"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorADTAuditDataUnknown, "GDBusErrorADTAuditDataUnknown"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorObjectPathInUse, "GDBusErrorObjectPathInUse"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorUnknownObject, "GDBusErrorUnknownObject"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorUnknownInterface, "GDBusErrorUnknownInterface"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorUnknownProperty, "GDBusErrorUnknownProperty"),
        std::pair<DeviceError, QString>(DeviceError::GDBusErrorPropertyReadOnly, "GDBusErrorPropertyReadOnly"),

        std::pair<DeviceError, QString>(DeviceError::UserErrorNotMountable, "Device is not mountable"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNotEjectable, "Device is not ejectable"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNoDriver, "Device do not have a drive"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNotEncryptable, "Device is not encryptable"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNoPartition, "Device do not have a partition"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNoBlock, "Device do not have a block"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNetworkWrongPasswd, "Wrong username or password"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNetworkAnonymousNotAllowed, "Anonymous login is not allowed"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorTimedOut, "Operation timeout"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorAlreadyMounted, "Device is already mounted"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorNotMounted, "Device is not mounted"),
        std::pair<DeviceError, QString>(DeviceError::UserErrorFailed, "Operation failed"),

        std::pair<DeviceError, QString>(DeviceError::UnhandledError, "Unhandled error"),
    };
